...
subtitle: "Модель конкуренции двух фирм - вариант 65"
...
$$\frac{dM_1}{d\Theta} = M_1 - (\frac{b}{c_1} + 0.00065)M_1 M_2 - \frac{a1}{c1} M_1^2 $$
...
$$ p_{cr}=35 \: N=30 \: q=1 $$
$$ \tau_1=16 \: \tau_2=20 $$
$$ \widetilde{p}_1=9.9 \: \widetilde{p}_2=8.5 $$
