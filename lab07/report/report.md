...
subtitle: "Модель распространения рекламы - вариант 65"
...
3.	$\frac{dn}{dt} = (0.5\sin (t) + 0.4\cos (2t)n(t))(N-n(t))$

При этом объем аудитории $N = 1234$, в начальный момент о товаре знает 7 человек.
